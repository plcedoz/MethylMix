...
For user supplied data not from TCGA, the user can provide DNA methylation (beta-values) and gene expression data in the form of a data.matrix object in R. If the data contains batches, the user must provide numeric batch data within the matrices.
